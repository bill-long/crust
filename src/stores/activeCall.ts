 ...
 * survive route changes. When the user navigates away from the call's
 * room the full overlay collapses to a floating mini-widget; navigating
 * back re-expands the overlay — same session, no rejoin.
 *
