...
const TimelineView: Component<{
	...
	// Membership-group state: grouping of consecutive same-kind transitions
	// (join/leave/invite/kick/ban) plus expand/collapse tracking keyed by
	// member event ID. See useMembershipExpansion.
	const {
		membershipGroups,
		isGroupExpanded,
		expandGroup,
