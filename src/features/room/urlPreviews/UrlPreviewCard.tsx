	...
	return (
		<Show
			...
			fallback={
				<a
					...
					class="mt-1 flex min-h-11 max-w-xl items-center gap-3 rounded-md border border-border-subtle bg-surface-2 p-2 no-underline transition-colors hover:bg-surface-3 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-border-focus"
				>
					<TextColumn />
		...
		>
			<a
				...
				rel="noreferrer noopener"
				aria-label={ariaLabel()}
				class="mt-1 flex max-w-md flex-col overflow-hidden rounded-md border border-border-subtle bg-surface-2 no-underline transition-colors hover:bg-surface-3 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-border-focus"
			>
