	...
	return (
		...
		>
			<Popover.Trigger
				...
				class="relative inline-flex h-8 min-w-8 items-center justify-center gap-1 rounded px-1 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-hover any-pointer-coarse:h-11 any-pointer-coarse:min-w-11"
				classList={{
