				...
				<div class="flex min-w-0 items-center gap-1 overflow-x-auto [&>*]:shrink-0 sm:min-w-fit sm:shrink-0 sm:overflow-visible">
					...
					<Show when={props.canInvite()}>
						<button
							...
							class="inline-flex h-11 w-11 items-center justify-center rounded text-text-disabled transition-colors hover:bg-surface-2 hover:text-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-hover sm:h-8 sm:w-8"
					...
					<button
						...
						class="inline-flex h-11 w-11 items-center justify-center rounded transition-colors hover:bg-surface-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-hover sm:h-8 sm:w-8"
						classList={{
					...
					<button
						...
						class="inline-flex h-11 w-11 items-center justify-center rounded transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-hover sm:h-8 sm:w-8"
						classList={{
					...
					<button
						...
						class="inline-flex h-11 w-11 items-center justify-center rounded text-text-disabled transition-colors hover:bg-surface-2 hover:text-danger-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-hover disabled:cursor-not-allowed disabled:opacity-50 sm:h-8 sm:w-8"
